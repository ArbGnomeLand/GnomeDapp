...
export const DEFAULD_NETWORK = Networks.AETH;

export const AVAILABLE_CHAINS = [Networks.AVAX, Networks.AETH];
export const WMEMO_BRIDG_CHAINS = [Networks.AVAX, Networks.AETH];
export const BALANCE_CHAINS = [Networks.AETH];
