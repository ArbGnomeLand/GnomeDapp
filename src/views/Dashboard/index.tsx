                    ...
                    <Grid container spacing={4}>
                        <Grid item lg={12} md={12} sm={12} xs={12}>
                            <div className="dashboard-card-header">
                                <p className="dashboard-card-header-title">Gnomeland</p>
                            </div>
                        </Grid>
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                <p className="card-title">GNOME Price</p>
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                <p className="card-title">Backing per $wMEME</p>
                                <p className="card-value">
                                    {isAppLoading ? (
                        ...
                        <Grid item lg={6} md={6} sm={6} xs={12}>
                            <div className="dashboard-card">
                                ...
                                <p className="card-value">
                                    ...
                                    <span className="card-value-sub wmemo"> wGNOME</span>
                                </p>
                            </div>
                        </Grid>
                            ...
                            <div className="dashboard-card-header">
                                {providerChainID === Networks.AETH ? (
                                    <p className="dashboard-card-header-title">
                                        Personal Balance <span className="small">Arbitrum</span>
                                    </p>
                        ...
                        {address && providerChainID === Networks.AETH && (
                            <>
                        ...
                        {providerChainID !== Networks.AETH && providerChainID !== Networks.ETH && (
                            <Grid item lg={12} md={12} sm={12} xs={12}>
                                <div className="dashboard-card-wallet-notification">
